...
export const Icons = {
  ...
  Mastercard: () => (
    <img src="/mastercard-logo.png" alt="Mastercard" className="h-5 w-auto object-contain" />
  ),
  Amex: () => (
    <img src="/amex-logo.png" alt="American Express" className="h-5 w-auto object-contain" />
  ),
  Elo: () => (
    <img src="/elo-logo.png" alt="Elo" className="h-5 w-auto object-contain" />
  ),
